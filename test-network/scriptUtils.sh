...
function printHelp() {
  ...
  if [ "$USAGE" == "up" ]; then
    ...
    println "    -ccn <name> - Chaincode name. This flag can be used to deploy one of the asset transfer samples to a channel. Sample options: basicuser (default),ledger, private, sbe, secured"
    ...
    println
    println " Examples:"
    println "   network.sh deployCC -ccn basicuser -ccl javascript"
    ...
    println "      \033[0;32mdeployCC\033[0m - Deploy a chaincode to a channel (defaults to user-basic)"
